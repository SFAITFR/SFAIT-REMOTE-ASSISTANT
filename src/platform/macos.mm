...
static void OpenSystemSettingsUrl(NSString *urlString) {
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:urlString]];
    });
}

extern "C" void OpenAccessibilityPreferences() {
    OpenSystemSettingsUrl(@"x-apple.systempreferences:com.apple.preference.security?Privacy_Accessibility");
}

extern "C" void OpenScreenRecordingPreferences() {
    OpenSystemSettingsUrl(@"x-apple.systempreferences:com.apple.preference.security?Privacy_ScreenCapture");
}

extern "C" void OpenInputMonitoringPreferences() {
    OpenSystemSettingsUrl(@"x-apple.systempreferences:com.apple.preference.security?Privacy_ListenEvent");
}
